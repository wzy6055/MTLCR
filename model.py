...
def JiT_B_2(**kwargs):
    return JiT(depth=12, hidden_size=768, num_heads=12, bottleneck_dim=128, patch_size=2, **kwargs)

def JiT_B_4(**kwargs):
    return JiT(depth=12, hidden_size=768, num_heads=12, bottleneck_dim=128, patch_size=4, **kwargs)

def JiT_B_8(**kwargs):
    return JiT(depth=12, hidden_size=768, num_heads=12, bottleneck_dim=128, patch_size=8, **kwargs)
...
if __name__ == '__main__':
    ...
    device = "cuda:0"
    model = JiT_models['JiT-B/16'](in_channels=6).to(device)
    model.eval()
