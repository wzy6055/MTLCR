...
def EJiT_B_2(**kwargs):
    return JiT(depth=12, hidden_size=96, num_heads=12, bottleneck_dim=16, patch_size=2, **kwargs)

def EJiT_B_4(**kwargs):
    return JiT(depth=12, hidden_size=192, num_heads=12, bottleneck_dim=32, patch_size=4, **kwargs)

def EJiT_B_8(**kwargs):
    return JiT(depth=12, hidden_size=384, num_heads=12, bottleneck_dim=64, patch_size=8, **kwargs)

def EJiT_B_16(**kwargs):
    return JiT(depth=12, hidden_size=768, num_heads=12, bottleneck_dim=128, patch_size=16, **kwargs)

def EJiT_B_32(**kwargs):
    return JiT(depth=12, hidden_size=1536, num_heads=12, bottleneck_dim=256, patch_size=32, **kwargs)
...
if __name__ == '__main__':
    device = "cuda:0"
    model = EJiT_models['EJiT-B/4'](in_channels=6).to(device)
